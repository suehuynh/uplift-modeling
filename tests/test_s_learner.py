"""Tests for src/models/s_learner.py"""
...
def synthetic_uplift_data():
    ...
    This lets us verify the T-Learner recovers the correct *direction*
...
class TestSLearner:
    ...
    def test_scale_pos_weight_applied(self, synthetic_uplift_data):
        X, treatment, outcome, _ = synthetic_uplift_data
        model = SLearner(name="s-learner", scale_pos_weight=5.0)
        assert model.model.get_params()["scale_pos_weight"] == 5.0
